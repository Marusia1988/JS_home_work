...
function untilBirthday(data) {
    ...
    elmnt.innerHTML = `Осталось  ${months + ' месяцев ' + days + ' дней ' + hours + ' часов ' + minutes + ' минут ' + second + ' секунд '}`;
}
...
if (cookieAge !== undefined || cookieAge === '' && cookieName !== undefined || cookieName === '') {
